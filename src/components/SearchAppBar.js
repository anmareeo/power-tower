  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <MenuItem onClick={handleClose} component = {RLink} to = "/testimonials">Testimonials</MenuItem>
        <MenuItem onClick={handleClose} component = {RLink} to = "/contact">Contact Us</MenuItem>
